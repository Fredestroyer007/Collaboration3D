...
Lors de l'usage de la visière, il est recommandé de la désinfecté périodiquement selon le protocole de la firme Laporte. Cliquer [ici](https://github.com/Fredestroyer007/Collaboration3D/blob/master/src/files/Proc%C3%A9dure_de_d%C3%A9sinfection.pdf) pour télécharger le protocole
